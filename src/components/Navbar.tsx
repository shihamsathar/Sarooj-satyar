        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline font-medium text-emerald-100">
              Official Grievance & Citizen Empowerment Portal • Periyamulla & Negombo Municipal Council
            </span>
          ...
          >
            ...
            <div>
              ...
              <div className="text-[10px] font-bold tracking-widest uppercase text-[#B38B37] flex items-center gap-1 mt-0.5">
                ...
                <span className="text-stone-500 font-medium normal-case text-[9px]">Negombo MC</span>
              </div>
            </div>
          </button>
        </div>
